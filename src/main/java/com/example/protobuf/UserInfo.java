...
public final class UserInfo {
    ...
    public  static final class UserMsg extends
        ...
        getDescriptor() {
            return internal_static_UserMsg_descriptor;
        }

        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
            return internal_static_UserMsg_fieldAccessorTable
                    .ensureFieldAccessorsInitialized(
                            UserMsg.class, UserMsg.Builder.class);
        }
        ...
        public static final class Builder extends
            ...
            // Construct using UserMsg.newBuilder()
            private Builder() {
